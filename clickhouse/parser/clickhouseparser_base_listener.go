...
func (s *BaseClickHouseParserListener) EnterAssignmentValues(ctx *AssignmentValuesContext) {}

// ExitAssignmentValues is called when production assignmentValues is exited.
func (s *BaseClickHouseParserListener) ExitAssignmentValues(ctx *AssignmentValuesContext) {}

// EnterAssignmentValue is called when production assignmentValue is entered.
func (s *BaseClickHouseParserListener) EnterAssignmentValue(ctx *AssignmentValueContext) {}

// ExitAssignmentValue is called when production assignmentValue is exited.
func (s *BaseClickHouseParserListener) ExitAssignmentValue(ctx *AssignmentValueContext) {}
